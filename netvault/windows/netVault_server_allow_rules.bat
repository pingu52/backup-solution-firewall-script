...
echo Allowing Windows Firewall rules for NetVault 12.4 Services...
...
netsh advfirewall firewall add rule name="NetVault Deployment Manager" dir=in action=allow program="%NETVAULT_PATH%\nvdeploymentmgr.exe"
...
echo Firewall rules for NetVault 12.4 services have been added.
pause
