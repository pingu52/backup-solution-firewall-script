@echo off
:: -----------------------------------------------------------------------------
:: Copyright (c) 2024 Hyeonggyun KIM, P1N9U, Terry
::
...
echo Removing Windows Firewall rules for NetVault 12.4 Services...
...
netsh advfirewall firewall delete rule name="NetVault Deployment Manager"
...
echo Firewall rules for NetVault 12.4 services have been removed.
pause
